...
function Product() {
   ...
   // let isMouted = true;
    ...
    const handleAddToCart = () => { 
        let exists = products.find(item => item.id===product.id)
        if(exists) {
        ...
        <div className={cx("product-item")}>
          ...
          <div className={cx("content")}>
            ...
            <p className={cx("policy")}>
              Suggested payments with 6 moths special finacing
            </p>
            ...
            <div className={cx("policy-wrap")}>
              <div className={cx("policy-item","bd-bottom")}>
                ...
                <div className={cx("policy-content")}>
                  <h4 className={cx("policy-title")}>Free Delivery</h4>
              ...
              <div className={cx("policy-item")}>
                ...
                <div className={cx("policy-content-other")}>
                  <h4 className={cx("policy-title")}>Return Delivery</h4>

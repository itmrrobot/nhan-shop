  ...
  const EmptyCart = () => {
    return (
      <div className={cx("wrapper")}>
        <h3 className={cx("title")}>My Cart</h3>
        <div className={cx("content")}>
          <div className={cx("wrap")}>
            <span className={cx("sentence")}>Cart is empty</span>
            <span className={cx("sentence")}>
              Please continue to search for products to add to cart
            </span>
                  ...
                  <div className={cx("container")}>
                    <div className={cx("wrap-btn")}>
                      <button
                        ...
                        onClick={() => {product.qty>1?decrement(product.id):setIsLessOne(true);handleDecrese();}}
                        disabled={isLessOne}
                      >
                        -
                      </button>
                      ...
                      <div
                        ...
                        onClick={() => {increment(product.id);handleIncrese()}}
                      >
                        +
                      </div>
                    </div>

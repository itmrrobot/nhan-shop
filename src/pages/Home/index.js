        ...
        <div className={cx("content")}>
          <div className={cx("policy-list")}>
            <div className={cx("policy-item")}>
              ...
              <h4 className={cx("policy-title")}>FREE DELIVERY FROM $ 250</h4>
            </div>
            <div className={cx("policy-item")}>
              <img src={policy2} alt="" className={cx("policy-img")} />
              <h4 className={cx("policy-title")}>MONEY BACK GUARANTEED</h4>
            </div>
            <div className={cx("policy-item")}>
              <img src={policy3} alt="" className={cx("policy-img")} />
              <h4 className={cx("policy-title")}>SECURE PAYMENT</h4>
            </div>
            <div className={cx("policy-item")}>
